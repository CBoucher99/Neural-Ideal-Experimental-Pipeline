...
- Colleen Boucher (2022-03-15) [Updated to include parenthesis for print command to work in Python 3]
        ...
        if (algorithm == "iterative"):
            ...
            if threading:
                ...
                for i in range(threads):
                    asyn.append(pool.apply_async(self._booleanRingReduce, ([splitM[i]])))
